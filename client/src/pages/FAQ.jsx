...
const faqs = [
  { q: 'What is Apex Finance?', a: 'Apex Finance LLC is a free loan matching service that connects borrowers with a network of licensed lenders. We are not a direct lender and do not make credit decisions or issue loans. Loan approval, terms, and rates are determined solely by the lender.', cat: 'General' },
  { q: 'Is Apex Finance a direct lender?', a: 'No. Apex Finance LLC is a loan matching service, not a direct lender. We work with a network of licensed lenders to help you find competitive rates and terms. This means you can compare multiple offers rather than being limited to a single lender.', cat: 'General' },
  ...
  { q: 'What credit score do I need?', a: 'Minimum credit score requirements vary by loan type and lender. Generally, a score of 580+ is needed for basic eligibility, while scores of 700+ may qualify for more competitive rates. We work with lenders who cater to various credit profiles. Not all applicants will qualify.', cat: 'Application Process' },
